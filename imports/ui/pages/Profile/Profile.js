  ...
  handleSubmit(form) {
    const profile = {
      ...
      profile: {
        ...
        sendingLimit: parseInt(form.sendingLimit.value),
  ...
  renderPasswordUser(loading, user) {
    return !loading ? (
      <div>
        ...
        <FormGroup>
          <ControlLabel>LinkedIn Daily Sending Limit</ControlLabel>
          <input
            type="number"
            name="sendingLimit"
            defaultValue={user.profile.sendingLimit}
            className="form-control"
          />
        </FormGroup>
        ...
        <Button className='poll-btn' type="submit">Update Profile</Button>
      </div>
    ) : null ;
  }
